...
class AzCliCommandParser(argparse.ArgumentParser):
    ...
    def __init__(self, **kwargs):
        print("Constructing a parser with {}".format(kwargs))
        self.subparsers = {}
    ...
    def load_command_table(self, command_table):
        ...
        # import sys
        # import os
        # print(os.path.exists(r'e:\azure-cli\src\command_modules\azure-cli-ml'))
        # sys.path.append(r'e:\azure-cli\src\command_modules\azure-cli-ml')
