...
helps['batch pool set'] = """
    type: command
    short-summary: Update the properties of the specified pool. Properties can be updated independently, but when a property is updated in a sub-group, for aml 'start task', all properties of that group are reset.
"""
...
helps['batch job set'] = """
    type: command
    short-summary: Update the properties of a job. Properties can be updated independently, but when a property is updated in a sub-group, for aml 'constraints' or 'pool info', all properties of that group are reset.
"""
